  ...
  return (
    <section>
      ...
      <div className="md:hidden">
        <div className="relative min-h-[317px]">
          <Image
        ...
        <div className="bg-black px-7 py-12 text-white">
          <p className="text-[12px] font-bold uppercase tracking-[2px]">
            Last Month&apos;s Featured Story
          </p>

          <h1 className="mt-4 text-[32px] font-bold uppercase leading-[1.1] tracking-[3.33px]">
          ...
          >
            ...
            <Image
              ...
              width={42}
              height={14}
              className="invert transition duration-300 group-hover:translate-x-1"
            />
          </Link>
        </div>
      </div>
      ...
      {/* Tablet and desktop */}
      <div className="relative hidden min-h-[650px] overflow-hidden bg-black text-white md:block">
        <picture>
          <source
          ...
          />
          <Image
            src="/assets/images/stories/tablet/moon-of-appalacia.jpg"
            alt="Moon over a mountain landscape at dusk"
            fill
            priority
            sizes="100vw"
        ...
        <div className="relative z-10 mx-auto flex min-h-[650px] max-w-[1440px] items-end px-10 py-28 lg:px-[112px]">
          <div className="max-w-[387px]">
            <p className="text-[12px] font-bold uppercase tracking-[2px]">
              Last Month&apos;s Featured Story
            </p>

            <h1 className="mt-4 text-[40px] font-bold uppercase leading-[1.1] tracking-[4.17px]">
              Hazy Full Moon of Appalachia
            </h1>
